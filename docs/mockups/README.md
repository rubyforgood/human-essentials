...
| `table-scroll-controls.html` | The fade says there is more and gives you nothing to act on. The scrollbar is an overlay taking 0px and on five of seven tables it is below the fold. What is the control? | **The correction built** — no fade over a frozen column, which was measured at 3.19:1 and failing 1.4.3. The control itself is **awaiting a decision**: recommends B, a drawn rail that sticks to the bottom of the viewport, as Ant Design, Confluence and Jira do. |
