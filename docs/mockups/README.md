...
| `pagination-designs.html` | The system already has a pager. What else would fit it, and does the pager say the right thing? | Awaiting a decision. Four designs against the built component; recommends A, keeping the numbered pager and replacing "Page 3 of 19" with "Showing 31–45 of 272". Argues against a rows-per-page select and against load-more. |
