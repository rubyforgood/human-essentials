...
## Logging out
You can log out by clicking your name in the top right corner, then clicking "Log Out".
...
You may have an id that works with multiple banks, or, more commonly, with a bank and a Partner.  To switch between these,  click on your name in the top right corner,  then the name of the organization (bank or Partner) that you want to switch to.
