...
[!WARNING]  Once you request recertification, the Partner will not be able to enter Requests until you have approved them again!! 
...
![Request Recertification button](images/partners/partners_recertification.png)
...
[!NOTE] They have a "Submit for Approval" button, which would change their status to "Awaiting review", and make them appear in your dashboard,  but you can bypass that step.
