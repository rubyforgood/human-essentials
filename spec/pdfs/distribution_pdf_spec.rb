  ...
  describe "pdf item and column displays" do
    ...
    context "with request data" do
      describe "#hide_columns" do
        ...
        context "when enable_packs is disabled" do
          it "hides value and package columns when true on organization, and does not include request unit info" do
          ...
          it "hides value columns when true on organization, and does not include request unit info" do
            Flipper.disable(:enable_packs)
    ...
    context "regardless of request data" do
      describe "#hide_columns" do
        ...
        context "when enable_packs is disabled" do
          it "hides package column when true on organization, and does not include request unit info" do
            Flipper.disable(:enable_packs)
