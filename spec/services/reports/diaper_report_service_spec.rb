RSpec.describe Reports::DiaperReportService, type: :service, persisted_data: true do
  describe "acquisition report" do
    ...
    before do
      ...
      create(:line_item, :distribution, quantity: 10, item: disposable_kit, itemizable: disposable_kit_item_distribution)
      create(:line_item, :distribution, quantity: 10, item: another_disposable_kit, itemizable: another_disposable_kit_item_distribution)
