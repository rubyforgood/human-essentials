...
RSpec.describe Transfer, type: :model do
  ...
  context "Methods >" do
    it "`self.storage_locations_transferred_to` and `..._from` constrains appropriately" do
      ...
      xfer1 = create(:transfer, from: storage_location3, to: storage_location1, organization: @organization)
      xfer2 = create(:transfer, from: storage_location3, to: storage_location2, organization: @organization)
      xfer3 = create(:transfer, from: storage_location5, to: storage_location4, organization: storage_location4.organization)
