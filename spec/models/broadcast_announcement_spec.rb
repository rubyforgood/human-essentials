...
RSpec.describe BroadcastAnnouncement, type: :model do
  ...
  context "filter_announcements" do
    ...
    it "sorts announcementsfrom most recently created to last" do 
      ...
      announcement_3 = BroadcastAnnouncement.create!(message: "test", user_id: 1, organization_id: 1, created_at: 3.days.ago)
      announcement_4 = BroadcastAnnouncement.create!(message: "test", user_id: 1, organization_id: 1, created_at: 4.days.ago)

      expect(BroadcastAnnouncement.filter_announcements(1)).to eq([announcement_1, announcement_2, announcement_3, announcement_4])
    end
  end
end
