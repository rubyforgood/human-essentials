  ...
  context "While signed in" do
    ...
    describe "GET #find" do
      ...
      context "via ajax" do
        subject do
          get :find,
              params: default_params.merge(barcode_item: { value: organization_barcode.value },
                                           format: :json)
        end
        ...
        it "can find a barcode that's universally available" do
          get :find, params: default_params.merge(barcode_item: { value: global_barcode.value },
                                                  format: :json)
        ...
        context "when it's missing" do
          it "returns a 404" do
            get :find, params: default_params.merge(barcode_item: { value: other_barcode.value },
                                                    format: :json)
    ...
    describe "DELETE #destroy" do
      it "disallows a user to delete someone else's barcode" do
        ...
        other_barcode = create(:barcode_item,
                               :for_organization,
