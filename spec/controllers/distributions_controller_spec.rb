RSpec.describe DistributionsController, type: :controller do
  ...
  describe "GET #print" do
    subject { get :print, params: { organization_id: @organization, id: create(:distribution).id } }
  ...
  describe "GET #reclaim" do
    subject { get :reclaim, params: { organization_id: @organization, id: create(:distribution).id } }
    it "returns http success" do
      expect(subject).to be_successful
    end
  end
  ...
  describe "GET #index" do
    subject { get :index, params: { organization_id: @organization } }
    it "returns http success" do
      expect(subject).to be_successful
    end
  end
  ...
  describe "GET #show" do
    subject { get :show, params: { organization_id: @organization.short_name, id: create(:distribution).id } }
    it "returns http success" do
      expect(subject).to be_successful
    end
  end
