module Query
  class ItemsByStorageCollectionAndQuantity
    ...
    def call
      @items_by_storage_collection ||= ItemsByStorageCollection.new(organization: organization, filter_params: filter_params).call
