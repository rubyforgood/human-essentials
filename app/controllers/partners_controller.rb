...
class PartnersController < ApplicationController
  ...
  def create
    ...
    if svc.errors.none?
      ...
      flash_error_unless_summarised(@partner, "Failed to add partner due to: #{svc.errors.full_messages}")
      render action: :new
    end
  end
  ...
  def update
    ...
    if @partner.update(partner_params)
      ...
      flash_error_unless_summarised(@partner, "Something didn't work quite right -- try again?")
      render action: :edit
    end
  end
  ...
  def partner_params
    params.require(:partner).permit(:name, :email, :phone_number, :send_reminders, :quota,
