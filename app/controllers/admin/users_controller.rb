...
class Admin::UsersController < AdminController
  ...
  def validate_role_resource_params
    ...
    raise "Please select an associated resource for the role." if Role::ROLES_WITHOUT_RESOURCE.map(&:to_s).includes?(params[:resource_type].to_s) && params[:resource_id].blank?
  end
