class Reports::NdbnAnnualsController < ApplicationController
  ...
  def show
    ...
    @year = params[:year]
    @reports = Reports::AnnualReport.all_reports(year: @year, organization: current_organization)

    respond_to do |format|
      format.html
      format.csv do
        send_data Exports::ExportReportCSVService.new(reports: @reports).generate_csv,
