class DistributionsController < ApplicationController
  ...
  def distribution_params
    params.require(:distribution).permit(:comment,:agency_rep, :distribution_date, :partner_id, :storage_location_id, line_items_attributes: [:item_id, :quantity, :_destroy])
  end
end
