class TransfersController < ApplicationController
  def index
    # FIXME: Combine these `includes` into a single `includes`
  ...
  def show
    # FIXME: Combine these `includes` lines into a single `includes` statement
    @transfer = current_organization.transfers
                                    .includes(:line_items)
                                    .includes(:from)
                                    .includes(:to)
                                    .includes(:items)
