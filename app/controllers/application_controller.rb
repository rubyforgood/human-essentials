class ApplicationController < ActionController::Base
  ...
  def current_organization
    ...
    # FIXME: SOMEHOW, the organization is getting deleted before it gets to this step
    @current_organization ||= Organization.find_by(short_name: params[:organization_id])
  end
