...
class DonationsController < ApplicationController
  ...
  def index
    ...
    @donations = current_organization.donations
                                     .includes(:storage_location, :donation_site, :diaper_drive, :product_drive_participant, :manufacturer, line_items: [:item])
  ...
  def donation_params
    ...
    params.require(:donation).permit(:source, :comment, :storage_location_id, :money_raised, :issued_at, :donation_site_id, :diaper_drive_id, :product_drive_participant_id, :manufacturer_id, line_items_attributes: %i(id item_id quantity _destroy)).merge(organization: current_organization)
  end
  ...
  helper_method \
    ...
    params.require(:filters).permit(:at_storage_location, :by_source, :from_donation_site, :by_diaper_drive, :by_product_drive_participant, :from_manufacturer)
  end
  ...
  def strip_unnecessary_params
    ...
    params[:donation].delete(:product_drive_participant_id) unless params[:donation][:source] == Donation::SOURCES[:diaper_drive]
    params
  end
