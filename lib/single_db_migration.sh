...
export DIAPER_DB_HOST=localhost
export DIAPER_DB_USERNAME=postgres
export DIAPER_DB_PASSWORD=password
export DIAPER_DB_DATABASE=diaper_dev
export PARTNER_DB_HOST=localhost
export PARTNER_DB_USERNAME=postgres
export PARTNER_DB_PASSWORD=password
export PARTNER_DB_DATABASE=partner_dev
