...
namespace :organizations do
  namespace :backfill do
    ...
    task default_email_text: :environment do |task|
      default_email_text = "<div class=\"trix-content\">\n  <div>%{partner_name},<br><br>Your diaper request has been approved and you can find attached to this email a copy of the distribution you will be receiving.<br><br>Your distribution has been set to be <strong>%{delivery_method}</strong> on <strong>%{distribution_date}</strong>.<br><br>See you soon!<br><br>%{comment}</div>\n</div>\n"
